    ...
    <div class="container mx-auto px-4 sm:px-6 lg:px-8">
                            ...
                            <div x-show="dropdownOpen" x-transition:enter="transition ease-out duration-200"
                                ...
                                <div
                                    ...
                                    <div class="flex items-center gap-2 min-w-0">
                                        <svg class="w-4 h-4 text-white flex-shrink-0" fill="none"
                                            stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                d="M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-4-5.659V5a2 2 0 10-4 0v.341C7.67 6.165 6 8.388 6 11v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9" />
                                        </svg>
        ...
        <div id="mobile-menu"
            ...
            <details class="group [&::-webkit-details-marker]:hidden">
                ...
                <div class="px-3 py-2 ml-2 border-l-2 border-emerald-100 space-y-1 mt-1">
                    <a href="{{ route('berita') }}"
                        class="flex items-center gap-3 px-3 py-2.5 text-sm text-slate-600 hover:text-emerald-600 hover:bg-emerald-50 rounded-lg transition-colors">Berita</a>
                    <a href="{{ route('apbd') }}"
