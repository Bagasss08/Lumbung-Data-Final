...
══════════════════════════════════════════════════════════════ --}}
    <style>
        ...
        .aksi-dropdown-portal .aksi-item-teal:hover {
            background: #f0fdfa;
            color: #134e4a;
        }

        .aksi-dropdown-portal .aksi-item-orange:hover {
            background: #fff7ed;
            color: #9a3412;
        }
        ...
        .dark .aksi-dropdown-portal .aksi-item-teal:hover {
            background: rgba(20, 184, 166, 0.12);
            color: #5eead4;
        }

        .dark .aksi-dropdown-portal .aksi-item-orange:hover {
