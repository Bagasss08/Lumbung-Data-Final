...
@section('content')
    ...
    <script>
        (function() {
            ...
            const wilayahLat = {{ is_numeric($rumahTangga->wilayah?->lat ?? null) ? $rumahTangga->wilayah->lat : 'null' }};
            const wilayahLng = {{ is_numeric($rumahTangga->wilayah?->lng ?? null) ? $rumahTangga->wilayah->lng : 'null' }};
