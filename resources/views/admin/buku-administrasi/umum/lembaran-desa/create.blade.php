...
@section('content')
    <div class="mb-6">
        ...
        <h1 class="text-2xl font-semibold text-gray-800">Tambah Data Lembaran/Berita Desa</h1>
    </div>

    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 max-w-5xl">
        <form action="{{ route('admin.buku-administrasi.umum.lembaran-desa.store') }}" method="POST">
            @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                ...
                <div></div> <div>
                    ...
                    <input type="text" name="nomor_ditetapkan" value="{{ old('nomor_ditetapkan') }}" required class="w-full border-gray-300 rounded-lg shadow-sm focus:ring-emerald-500">
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1">Tanggal Ditetapkan <span class="text-red-500">*</span></label>
                    <input type="date" name="tanggal_ditetapkan" value="{{ old('tanggal_ditetapkan') }}" required class="w-full border-gray-300 rounded-lg shadow-sm focus:ring-emerald-500">
                </div>
            </div>

            <div class="mb-6">
                <label class="block text-sm font-medium text-gray-700 mb-1">Tentang (Judul Peraturan) <span class="text-red-500">*</span></label>
                <textarea name="tentang" rows="2" required class="w-full border-gray-300 rounded-lg shadow-sm focus:ring-emerald-500">{{ old('tentang') }}</textarea>
            </div>

            <h3 class="text-lg font-medium text-gray-800 mb-4 border-b pb-2 mt-8">Diundangkan Dalam (Pilih Salah Satu/Keduanya)</h3>
            <div class="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4 mb-6">
                <div class="bg-gray-50 p-4 rounded-lg border border-gray-200">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="date" name="tanggal_diundangkan_lembaran" value="{{ old('tanggal_diundangkan_lembaran') }}" class="w-full border-gray-300 rounded-lg shadow-sm focus:ring-emerald-500 text-sm">
                    </div>
                    <div>
                        <label class="block text-xs font-medium text-gray-500 mb-1">Nomor Diundangkan</label>
                        <input type="text" name="nomor_diundangkan_lembaran" value="{{ old('nomor_diundangkan_lembaran') }}" class="w-full border-gray-300 rounded-lg shadow-sm focus:ring-emerald-500 text-sm">
                    </div>
                </div>
                ...
                <div class="bg-gray-50 p-4 rounded-lg border border-gray-200">
                    ...
                    <div class="mb-3">
                        <label class="block text-xs font-medium text-gray-500 mb-1">Tanggal Diundangkan</label>
                        <input type="date" name="tanggal_diundangkan_berita" value="{{ old('tanggal_diundangkan_berita') }}" class="w-full border-gray-300 rounded-lg shadow-sm focus:ring-emerald-500 text-sm">
                    </div>
                    <div>
                        <label class="block text-xs font-medium text-gray-500 mb-1">Nomor Diundangkan</label>
                        <input type="text" name="nomor_diundangkan_berita" value="{{ old('nomor_diundangkan_berita') }}" class="w-full border-gray-300 rounded-lg shadow-sm focus:ring-emerald-500 text-sm">
                    </div>
                </div>
            </div>
