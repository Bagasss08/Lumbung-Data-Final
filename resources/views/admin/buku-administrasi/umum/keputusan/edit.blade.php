...
@section('title', 'Edit Keputusan Kepala Desa')
...
@section('content')
    <div class="mb-6">
        ...
        <h1 class="text-2xl font-semibold text-gray-800">Edit Keputusan Kepala Desa</h1>
    </div>

    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 max-w-4xl">
        <form action="{{ route('admin.buku-administrasi.umum.keputusan.update', $keputusan->id) }}" method="POST">
            @csrf
            @method('PUT')
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                <div>
                    ...
                    <input type="text" name="nomor_keputusan" value="{{ old('nomor_keputusan', $keputusan->nomor_keputusan) }}" required 
                ...
                <div>
                    ...
                    <input type="date" name="tanggal_keputusan" value="{{ old('tanggal_keputusan', $keputusan->tanggal_keputusan) }}" required 
                           class="w-full border-gray-300 rounded-lg shadow-sm focus:border-emerald-500 focus:ring-emerald-500">
            ...
            <div class="mb-6">
                ...
                <textarea name="tentang" rows="3" required 
                          class="w-full border-gray-300 rounded-lg shadow-sm focus:border-emerald-500 focus:ring-emerald-500">{{ old('tentang', $keputusan->tentang) }}</textarea>
            ...
            <div class="mb-6">
                ...
                <textarea name="uraian_singkat" rows="3" 
                          class="w-full border-gray-300 rounded-lg shadow-sm focus:border-emerald-500 focus:ring-emerald-500">{{ old('uraian_singkat', $keputusan->uraian_singkat) }}</textarea>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                <div>
                    ...
                    <input type="text" name="nomor_dilaporkan" value="{{ old('nomor_dilaporkan', $keputusan->nomor_dilaporkan) }}" 
                           class="w-full border-gray-300 rounded-lg shadow-sm focus:border-emerald-500 focus:ring-emerald-500">
                </div>

                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1">Tanggal Dilaporkan</label>
                    <input type="date" name="tanggal_dilaporkan" value="{{ old('tanggal_dilaporkan', $keputusan->tanggal_dilaporkan) }}" 
                           class="w-full border-gray-300 rounded-lg shadow-sm focus:border-emerald-500 focus:ring-emerald-500">
                </div>
            </div>
            ...
            <div class="mb-6">
                ...
                <textarea name="keterangan" rows="2" 
                          class="w-full border-gray-300 rounded-lg shadow-sm focus:border-emerald-500 focus:ring-emerald-500">{{ old('keterangan', $keputusan->keterangan) }}</textarea>
            </div>

            <div class="flex justify-end gap-3">
                <a href="{{ route('admin.buku-administrasi.umum.keputusan.index') }}" class="px-4 py-2 border border-gray-300 rounded-lg text-gray-700 bg-white hover:bg-gray-50 transition-colors">Batal</a>
