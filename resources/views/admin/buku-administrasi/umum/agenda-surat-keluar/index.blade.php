...
@section('content')
    <div class="flex justify-between items-center mb-6">
        <div>
            <h1 class="text-2xl font-semibold text-gray-800">Buku Agenda Surat Keluar</h1>
            <p class="text-sm text-gray-500">Pencatatan agenda surat yang dikeluarkan oleh desa</p>
        </div>
            ...
            <table class="w-full whitespace-nowrap text-left text-sm text-gray-600">
                <thead class="bg-gray-50 border-b border-gray-200 text-gray-700 font-semibold">
                    <tr>
                        ...
                        <th class="px-6 py-4">Isi Singkat / Perihal</th>
                ...
                <tbody class="divide-y divide-gray-200">
                    @forelse($suratKeluar as $index => $item)
                        <tr class="hover:bg-gray-50 transition-colors">
                            <td class="px-6 py-4 text-center">{{ $suratKeluar->firstItem() + $index }}</td>
                            <td class="px-6 py-4">
                            ...
                            <td class="px-6 py-4 whitespace-normal min-w-[200px]">{{ $item->isi_singkat }}</td>
                            <td class="px-6 py-4 text-center">
                                <div class="flex items-center justify-center gap-2">
                                    <a href="{{ route('admin.buku-administrasi.umum.agenda-surat-keluar.edit', $item->id) }}" class="text-amber-500 hover:text-amber-600 bg-amber-50 hover:bg-amber-100 p-2 rounded transition-colors">
                                        Edit
                                    </a>
                    ...
                    @empty
                        <tr>
                            <td colspan="6" class="px-6 py-8 text-center text-gray-500">
                                Data Buku Agenda Surat Keluar belum tersedia.
                            </td>
                        </tr>
                    @endforelse
                </tbody>
