    ...
    <div class="flex items-center justify-between">
        <div>
            <div class="flex items-center gap-2 text-xs text-gray-400 mb-1">
                ...
                <span class="text-gray-300">/</span>
                <span class="text-gray-600 font-medium">Edit Dusun</span>
            </div>
        </div>
            ...
            <div class="flex items-center justify-between">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p class="text-emerald-100 text-xs mt-0.5">Ubah informasi dusun sesuai data terbaru yang valid
                        </p>
                    </div>
                </div>
                <div
                    class="inline-flex items-center gap-1.5 bg-white/20 border border-white/30 rounded-full px-3 py-1.5">
                    ...
                    <span class="text-xs font-semibold text-white">{{ $wilayah['nama'] ?? 'Dusun' }}</span>
                </div>
            </div>
        </div>
        ...
        <form method="POST" action="{{ route('admin.info-desa.wilayah-administratif.update', $wilayah['id']) }}">
            ...
            <div class="p-6 space-y-6">
                ...
                <div class="flex items-center gap-2.5 bg-amber-50 border border-amber-200 rounded-xl px-4 py-3">
                    ...
                    <p class="text-amber-700 text-xs">
                        Perubahan akan disimpan setelah menekan <strong class="text-amber-600">Simpan
                            Perubahan</strong>. Pastikan semua data sudah benar.
                    </p>
                </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div class="space-y-1.5">
                            <label for="nama" class="flex items-center gap-1.5 text-sm font-semibold text-gray-700">
                                ...
                                <span class="changed-dot hidden w-2 h-2 bg-amber-400 rounded-full animate-pulse"
                                    id="dot-nama"></span>
                            </label>
                            <div class="relative">
                                ...
                                <input type="text" name="nama" id="nama" value="{{ old('nama', $wilayah['nama']) }}"
                                    required placeholder="Contoh: Dusun Krajan" data-original="{{ $wilayah['nama'] }}"
                        ...
                        <div class="space-y-1.5">
                            ...
                            <div class="relative">
                                ...
                                <input type="text" name="kepala_wilayah" id="kepala_wilayah"
                                    ...
                                    data-original="{{ $wilayah['kepala_wilayah'] }}" class="w-full pl-10 pr-4 py-2.5 text-sm border border-gray-200 rounded-xl bg-gray-50 text-gray-900 placeholder-gray-400
                                              focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent focus:bg-white
                                              hover:border-gray-300 hover:bg-white transition-all duration-150
                ...
                <div>
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        {{-- RW --}}
                        <div class="space-y-1.5">
                            <label for="rw" class="flex items-center gap-1.5 text-sm font-semibold text-gray-700">
                            ...
                            <div
                                ...
                                <input type="number" name="rw" id="rw" value="{{ old('rw', $wilayah['rw']) }}" min="1"
                                    required data-original="{{ $wilayah['rw'] }}"
                        ...
                        {{-- RT --}}
                        <div class="space-y-1.5">
                            <label for="rt" class="flex items-center gap-1.5 text-sm font-semibold text-gray-700">
                            ...
                            <div
                                ...
                                <input type="number" name="rt" id="rt" value="{{ old('rt', $wilayah['rt']) }}" min="1"
                                    required data-original="{{ $wilayah['rt'] }}"
                                    class="flex-1 text-center text-sm font-bold text-gray-900 bg-transparent border-none outline-none py-2.5 min-w-0"
                                    style="-moz-appearance:textfield">
                                <button type="button" onclick="changeVal('rt', 1)"
                                    class="px-3.5 py-2.5 text-gray-500 hover:text-emerald-600 hover:bg-emerald-50 font-bold text-base transition-colors duration-150 flex-shrink-0 border-l border-gray-200">
                ...
                <div>
                    ...
                    <div class="space-y-1.5 mb-4">
                        <label for="kk" class="flex items-center gap-1.5 text-sm font-semibold text-gray-700">
                        ...
                        <div
                            ...
                            <input type="number" name="kk" id="kk" value="{{ old('kk', $wilayah['kk']) }}" min="0"
                                required data-original="{{ $wilayah['kk'] }}"
                                class="flex-1 text-center text-sm font-bold text-gray-900 bg-transparent border-none outline-none py-2.5 min-w-0"
                                style="-moz-appearance:textfield">
                            <button type="button" onclick="changeVal('kk', 1)"
                                class="px-3.5 py-2.5 text-gray-500 hover:text-emerald-600 hover:bg-emerald-50 font-bold text-base transition-colors duration-150 flex-shrink-0 border-l border-gray-200">
                    ...
                    <div class="grid grid-cols-2 gap-4 mb-4">
                        ...
                        <div class="space-y-1.5">
                            <label for="laki_laki"
                                class="flex items-center gap-1.5 text-sm font-semibold text-gray-700">
                                <span class="text-blue-500">♂</span> Jumlah Laki-laki <span
                                    class="text-red-500">*</span>
                                <span class="changed-dot hidden w-2 h-2 bg-amber-400 rounded-full animate-pulse"
                                    id="dot-laki_laki"></span>
                            </label>
                            <div
                                ...
                                <input type="number" name="laki_laki" id="laki_laki"
                                    ...
                                    data-original="{{ $wilayah['laki_laki'] }}"
                                    class="flex-1 text-center text-sm font-bold text-gray-900 bg-transparent border-none outline-none py-2.5 min-w-0"
                                    style="-moz-appearance:textfield">
                                <button type="button" onclick="changeVal('laki_laki', 1)"
                        ...
                        <div class="space-y-1.5">
                            <label for="perempuan"
                                class="flex items-center gap-1.5 text-sm font-semibold text-gray-700">
                                <span class="text-pink-500">♀</span> Jumlah Perempuan <span
                                    class="text-red-500">*</span>
                                <span class="changed-dot hidden w-2 h-2 bg-amber-400 rounded-full animate-pulse"
                                    id="dot-perempuan"></span>
                            </label>
                            <div
                                ...
                                <input type="number" name="perempuan" id="perempuan"
                                    ...
                                    data-original="{{ $wilayah['perempuan'] }}"
                                    class="flex-1 text-center text-sm font-bold text-gray-900 bg-transparent border-none outline-none py-2.5 min-w-0"
                                    style="-moz-appearance:textfield">
                                <button type="button" onclick="changeVal('perempuan', 1)"
                    ...
                    <div class="flex gap-3 flex-wrap">
                        {{-- Total penduduk --}}
                        <div
                            class="flex-1 flex items-center gap-2.5 bg-emerald-50 border border-emerald-200 rounded-xl px-4 py-3">
                        ...
                        <div id="change-counter"
                            class="hidden flex items-center gap-2.5 bg-amber-50 border border-amber-200 rounded-xl px-4 py-3">
                            <svg class="w-4 h-4 text-amber-500 flex-shrink-0" fill="none" stroke="currentColor"
                                viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            ...
                            <p class="text-sm text-amber-700">
                                <span id="change-text" class="font-semibold">0 field</span> diubah
                            </p>
                        </div>
                    </div>
            ...
            <div class="flex items-center justify-between px-6 py-4 bg-gray-50 border-t border-gray-100">
                <div class="flex items-center gap-1.5 text-xs text-gray-400">
                    ...
                    ID Dusun: <strong class="text-gray-500 font-semibold">{{ $wilayah['id'] }}</strong>
                </div>
                <div class="flex items-center gap-3">
                    <a href="{{ route('admin.info-desa.wilayah-administratif') }}"
...
<script>
    ...
    function checkChanged(input) {
        ...
        if (dot) {
            if (String(input.value) !== String(input.dataset.original)) {
