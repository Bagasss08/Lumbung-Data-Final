    ...
    <div class="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden">
        <form method="POST" action="{{ route('admin.layanan-surat.template-surat.store') }}" class="p-6 sm:p-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                ...
                <div>
                    <label class="block text-sm font-semibold text-gray-700 mb-2">Format Nomor Surat</label>
                    <input type="text" name="format_nomor" value="{{ old('format_nomor') }}" placeholder="Contoh: 400/ [nomor] /2026"
                        class="w-full px-4 py-2.5 bg-gray-50 border border-gray-300 rounded-lg focus:bg-white focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 transition-all text-sm @error('format_nomor') border-red-500 @enderror">
                    @error('format_nomor') <p class="mt-1 text-xs text-red-500">{{ $message }}</p> @enderror
                </div>
            </div>

            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                <div>
                    <label class="block text-sm font-semibold text-gray-700 mb-2">Kode Klasifikasi</label>
                    <input type="text" name="kode_klasifikasi" value="{{ old('kode_klasifikasi') }}" placeholder="Contoh: 400"
                        class="w-full px-4 py-2.5 bg-gray-50 border border-gray-300 rounded-lg focus:bg-white focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 transition-all text-sm @error('kode_klasifikasi') border-red-500 @enderror">
