            ...
            <div class="overflow-x-auto">
                <table class="w-full text-left">
                    ...
                    <tbody class="divide-y divide-slate-50">
                            ...
                            <tr class="hover:bg-slate-50/80 transition-all group">
                                <td class="px-8 py-6">
                                    <div class="flex flex-col">
                                        <span class="text-sm font-bold text-slate-800 mb-0.5">{{ $program->nama }}</span>
                                ...
                                <td class="px-8 py-6">
                                    <div class="flex flex-col">
                                        <span
                                            class="text-xs font-bold text-slate-700">{{ $program->asal_dana ?? '-' }}</span>
                                    </div>
                                </td>
                                <td class="px-8 py-6 text-center">
                                    <span
                                        ...
                                        {{ $program->sasaran == 1 ? 'Penduduk' : $program->sasaran }}
                                    </span>
                                </td>
                                <td class="px-8 py-6 text-center">
                        ...
                        @empty
                            <tr>
                                <td colspan="5" class="px-8 py-10 text-center text-slate-400 text-sm">Belum ada data
                                    program.</td>
                            </tr>
                        @endforelse
                    </tbody>
