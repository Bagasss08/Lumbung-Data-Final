...
<div class="container mx-auto px-4 py-8">
    {{-- Banner Selamat Datang: Efek Fade Down agar turun perlahan dari atas --}}
    ...
    {{-- Alert Pesan: Efek Zoom In agar langsung mencuri perhatian warga --}}
    ...
    {{-- Grid Menu: Menggunakan Fade Up dengan delay yang berbeda (Staggered) agar muncul satu per satu --}}
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">

        {{-- Profil Saya --}}
        <a href="{{ route('warga.profil') }}"
           class="group bg-white p-6 rounded-2xl shadow-sm border border-slate-100 hover:shadow-md transition-all duration-300 hover:-translate-y-1"
           data-aos="fade-up"
           data-aos-delay="300"
           data-aos-duration="800">
        ...
        <a href="{{ route('warga.pesan.index') }}"
           class="group bg-white p-6 rounded-2xl shadow-sm border border-slate-100 hover:shadow-md transition-all duration-300 hover:-translate-y-1 relative"
           data-aos="fade-up"
           data-aos-delay="500"
           data-aos-duration="800">
            @if($unreadWargaPesan > 0)
